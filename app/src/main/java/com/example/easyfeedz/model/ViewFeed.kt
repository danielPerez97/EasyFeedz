...
sealed class ViewFeed
{
    ...
    data class TwitterFeed(val name: String, val username : String, val tweetText : String, val url: String): ViewFeed()
    ...
    data class TwitchFeed(val channel : String, val url : String, val description: String): ViewFeed()
